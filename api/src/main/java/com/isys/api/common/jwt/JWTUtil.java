...
public class JWTUtil {
    ...
    public String getUserGroup_Fk(String token) {

        return Jwts.parser().verifyWith(secretKey).build().parseSignedClaims(token).getPayload().get("USERGROUP_FK", String.class);
    }
